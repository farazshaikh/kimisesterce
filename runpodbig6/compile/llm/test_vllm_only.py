#!/usr/bin/env python3
"""Quick vLLM inference test - 3 requests to account for cold start."""
...
print(f"\n{'='*80}")
print(f"Testing vLLM - Qwen3-235B-A22B-Instruct-FP8")
print(f"{'='*80}")
...
try:
    ...
    output_file = f"/compile/llm/eval_vllm_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
